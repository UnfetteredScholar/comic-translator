...
export function ExportButton({ imageBase64, textBoxes, onExport }: ExportButtonProps) {
  ...
  async function handleExport() {
    ...
    try {
      ...
      const { base64: exportedImageBase64, previewUrl: exportedPreviewUrl } = await replaceImageText(imageBase64, toTranslatedTextBoxes(textBoxes));
